...
[NOTE]
====
모든 VMware vSphere 라이선스가 지원되므로 Enterprise 또는 Enterprise Plus 라이선스 대신 vSphere Remote Office Branch Office Standard 또는 Advanced 라이선스를 선택할 수 있습니다.

모든 vSphere 및 VSAN 라이센스가 지원됩니다.
