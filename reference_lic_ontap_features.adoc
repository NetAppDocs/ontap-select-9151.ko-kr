...
* FlexCache
+
ONTAP Select에서 FlexCache 쓰기 저장 지원에는 제한 사항이 있습니다. 자세한 내용은 link:https://docs.netapp.com/us-en/ontap-select/concept_ots_overview.html#flexcache-write-back-with-ontap-select["FlexCache ONTAP Select를 사용한 쓰기 저장"^]를 참조하십시오.
